...
g = GODag("/home/miguel/projects/omics/transfer_data/gly_data/data/go-basic.obo")

file = open('/home/miguel/projects/omics/transfer_data/gly_data/data/genes.txt','r')
genes = [x.strip() for x in file.readlines()]
file.close()

g2t = pd.read_csv("/home/miguel/projects/omics/transfer_data/gly_data/data/gene_term_raw.csv", dtype=object)
...
g2t.to_csv("/home/miguel/projects/omics/transfer_data/gly_data/data/gene_term.csv", index=False)
...
# isa.to_csv("/home/miguel/projects/omics/transfer_data/gly_data/data/isa.csv", index=False)
...
# term_def.to_csv("/home/miguel/projects/omics/transfer_data/gly_data/data/term_def.csv", index=False)

data_gcn = pd.read_csv("/home/miguel/projects/omics/transfer_data/gly_data/data/edgelist.csv")
...
file = open('/home/miguel/projects/omics/transfer_data/gly_data/data/terms.txt', 'w')
file.write('\n'.join(terms[pt_idx]))
file.close()
if int(sys.argv[1]):
  sys.exit()
...
df_subh.to_csv('/home/miguel/projects/omics/transfer_data/gly_data/data/subhierarchies.csv', index=False)
...
list2file(test_r, "/home/miguel/projects/omics/transfer_data/gly_data/data/roots.txt")
for x, root in zip(test_hpt, test_r):
  path = "/home/miguel/projects/omics/transfer_data/gly_data/data/{0}".format(root.replace(':',''))
  create_path(path)
...
for j, (x, root) in tqdm(enumerate(zip(test_hpt, test_rid))):
  ...
  path = "/home/miguel/projects/omics/transfer_data/gly_data/data/{0}".format(hterms[0].replace(':',''))
  create_path(path)
...
for i, (root, hterms) in tqdm(enumerate(zip(test_rid, test_hpt)), total=len(test_rid), ascii="-#", desc="GLY"):
  ...
  path = "/home/miguel/projects/omics/transfer_data/gly_data/data/{0}".format(term.replace(':',''))
