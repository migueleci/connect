...
g = GODag("/home/miguel/projects/omics/transfer_data/osa_data/data/go-basic.obo")

file = open('/home/miguel/projects/omics/transfer_data/osa_data/data/genes.txt','r')
genes = [x.strip() for x in file.readlines()]
file.close()

g2t = pd.read_csv("/home/miguel/projects/omics/transfer_data/osa_data/data/gene_term_raw.csv", dtype=object)
...
g2t.to_csv("/home/miguel/projects/omics/transfer_data/osa_data/data/gene_term.csv", index=False)
...
# isa.to_csv("/home/miguel/projects/omics/transfer_data/osa_data/data/isa.csv", index=False)
...
# term_def.to_csv("/home/miguel/projects/omics/transfer_data/osa_data/data/term_def.csv", index=False)

data_gcn = pd.read_csv("/home/miguel/projects/omics/transfer_data/osa_data/data/edgelist.csv")
...
"""
                **New**     **Old**
Genes: 		        22698       19663
Co-expression: 	8771819      550813
GO terms: 	       4668        3531
GO hier.: 	       8406        6367
Gene annot.: 	   344943      197194
"""
...
for i in range(nA):
  if 10 <= np.count_nonzero(gene_by_go[:,i]):
    ft_idx.append(i)
...
file = open('/home/miguel/projects/omics/transfer_data/osa_data/data/terms.txt', 'w')
file.write('\n'.join(terms[pt_idx]))
file.close()
if int(sys.argv[1]):
  sys.exit()
...
df_subh.to_csv('/home/miguel/projects/omics/transfer_data/osa_data/data/subhierarchies.csv', index=False)
...
"""
 ...
 2600 GO:0040007    9  167 growth	                                         1
  203 GO:0002376   15	 714 immune system process	                         1
 2924 GO:0044419   26	 795 biological process involved in interspecies ... 1
 2311 GO:0032501   33	 999 multicellular organismal process	               1
 2043 GO:0022414   52	 803 reproductive process	                           1
 2312 GO:0032502  103	1321 developmental process	                         1
 3444 GO:0050896  179	3813 response to stimulus	                           1
 3498 GO:0051179  185	1828 localization	                                   1
 3810 GO:0065007  446	3194 biological regulation	                         1
  850 GO:0008152  739	7780 metabolic process	                             1
 1308 GO:0009987 1017	8808 cellular process	                               1
"""
# %%
...
list2file(test_r, "/home/miguel/projects/omics/transfer_data/osa_data/data/roots.txt")
for x, root in zip(test_hpt, test_r):
  path = "/home/miguel/projects/omics/transfer_data/osa_data/data/{0}".format(root.replace(':',''))
  create_path(path)
...
for j, (x, root) in tqdm(enumerate(zip(test_hpt, test_rid))):
  ...
  path = "/home/miguel/projects/omics/transfer_data/osa_data/data/{0}".format(hterms[0].replace(':',''))
  create_path(path)
...
for i, (root, hterms) in tqdm(enumerate(zip(test_rid, test_hpt)), total=len(test_rid), ascii="-#", desc="OSA"):
  ...
  path = "/home/miguel/projects/omics/transfer_data/osa_data/data/{0}".format(term.replace(':',''))
